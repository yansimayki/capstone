    ...
    <div class="modal-content">
      ...
      <div class="viewwrapper">
            ...
            <div class=imgcontainer>
                 ...
                 <p><strong>Grade Handle: </strong> <span id="Grade"></p>
                 <p><strong>Section Handle: </strong> <span id="Section"></p>
            </div>
            <div class="info">
                 <p><strong>Fullname: </strong> <span id="tFname"></span> <span id="Mname"></span> <span id="Lname"></span></p>
...
<script src="{{ asset('assets/js/modules/listteacher.js') }}"></script>
